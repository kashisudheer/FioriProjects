sap.ui.define([
	...
	return Opa5.extend("demo.oft.zoft_etag_support.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["demo/oft/zoft_etag_support/localService/mockserver"], function (mockserver) {
